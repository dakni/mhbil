...
df <- data.frame(id=c(0,1), v=c(0,5))
csm5 <- subs(csm5, df)
csm6 <- cost_surface6 == min(cost_surface1b,cost_surface2,cost_surface3,cost_surface4,cost_surface5,cost_surface6b,cost_surface7,cost_surface8,cost_surface9)
df <- data.frame(id=c(0,1), v=c(0,6))
csm6 <- subs(csm6, df)
...
#plot(csm2, col = gray.colors(25, start = 0.97, end = 0.4))
#points(starts, pch=16, cex=0.8)  
